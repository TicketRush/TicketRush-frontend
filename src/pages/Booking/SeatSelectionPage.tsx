    ...
    <div className="max-w-5xl mx-auto px-4 py-6 space-y-4">
      ...
      <div className="bg-white border border-border rounded-xl p-6">
        ...
        {/* 좌석 그리드 — 가로 스크롤 대신 뷰포트 줌/팬 (#344).
            ...
            줌은 버튼·+ - 0·Ctrl(Cmd)+휠·핀치. 일반 휠은 페이지 스크롤.
            + - 0은 맵이나 좌석에 포커스가 있을 때 동작하고, Enter·Space 좌석 선택은 그대로 둔다.
            좌석에 포커스가 있으면 그 좌석을 기준으로 확대하고, 키보드로 옮긴 포커스가 보이게 팬한다.
            좌석에서는 방향키로 인접 좌석으로 옮기고, 맵 자체에서는 확대된 뒤에만 방향키로 둘러본다.
