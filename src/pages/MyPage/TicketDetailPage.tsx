...
//   - 티켓 이미지 다운로드 (#91) — html2canvas로 ticket 영역 캡처
//   - 좌석 long-press 맵 (#92) — 좌석 영역 500ms 누르면 좌석맵 팝오버
//   - 진입 시 좌석 long-press 툴팁 자동 노출 3초
  ...
  async function handleDownload() {
    ...
    try {
      const canvas = await html2canvas(ticketRef.current, {
        ...
        scale: 2, // 고해상도
        useCORS: true, // 포스터 이미지 cross-origin 대응
      });
      ...
      link.href = url;
      link.download = `ticket-${data!.bookingNumber}.png`;
          ...
          <div className="p-5">
            ...
            <div className="grid grid-cols-2 gap-3 mb-3">
              ...
              >
                ...
                <p className="text-sm font-bold truncate">{data.seatLabel}</p>
