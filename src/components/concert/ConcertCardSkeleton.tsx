...
export default function ConcertCardSkeleton() {
  return (
    <div className="h-full flex flex-col rounded-xl overflow-hidden bg-white shadow-card">
      {/* 포스터 영역 (4:3) */}
      <div className="aspect-[4/3] shrink-0 bg-gradient-to-b from-poster-fallback to-poster-fallback-end animate-pulse" />
