...
export default function ShowDateInput({ value, onChange, onKeyDown }: {
  value: string;
  ...
  return (
    <fieldset aria-label="공연 날짜">
      <DatePartsInput id="show-date" data-form-focus="true" onKeyDown={onKeyDown} value={{ year, month, day }} onChange={(parts) => {
